...
$sqlEdit = "UPDATE rent_product SET name = '$name', category_id = '$category', content = '$content', img = '$image', quantity = '$quantity', quantity_available = '$quantity_available', rent_price_category_id = '$rent_price', price = '$price', update_at = '$now' WHERE id = $id";
