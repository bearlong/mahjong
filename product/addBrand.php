...
$sql = "SELECT * FROM brand WHERE valid = 1 ORDER BY id DESC";
...
<body>
    ...
    <div class="container main-content px-5">
        ...
        <div class="row justify-content-center">
            <div class="col-4">
                <h3 class="mb-2">新增品牌</h3>
                <form action="doAddBrand.php" method="post">
            ...
            <div class="col-4">
                <h3 class="mb-2">刪除品牌</h3>
                <ul class="list-group">
                    <?php foreach ($rows as $brand) : ?>
                        <li class="list-group-item list-item deleteBtn" data-id="doDeleteBrand.php?id=<?= $brand["id"] ?>" data-bs-toggle="modal" data-bs-target="#deleteBackdrop"><?= $brand["name"] ?></li>
                    <?php endforeach; ?>
                </ul>
            </div>
        </div>
